  ...
  return (
    <div className="min-h-screen w-full bg-black text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 w-full h-full">
        ...
        {/* Geometric shapes */}
        <div className="absolute top-1/4 left-1/4 w-20 h-20 sm:w-32 sm:h-32 lg:w-40 lg:h-40 border border-brand-blue/30 rounded-lg animate-float" style={{ animationDelay: "0s" }} />
        <div className="absolute top-3/4 right-1/4 w-16 h-16 sm:w-24 sm:h-24 lg:w-32 lg:h-32 border border-brand-blue/20 rounded-lg animate-float" style={{ animationDelay: "2s" }} />
        <div className="absolute bottom-1/4 left-1/3 w-24 h-24 sm:w-40 sm:h-40 lg:w-48 lg:h-48 border border-brand-blue/10 rounded-lg animate-float" style={{ animationDelay: "4s" }} />

        {/* Additional responsive shapes */}
        <div className="absolute top-1/2 right-1/3 w-12 h-12 sm:w-20 sm:h-20 lg:w-28 lg:h-28 border border-brand-blue/15 rounded-lg animate-float" style={{ animationDelay: "1s" }} />
        <div className="absolute bottom-1/3 right-1/4 w-14 h-14 sm:w-24 sm:h-24 lg:w-32 lg:h-32 border border-brand-blue/25 rounded-lg animate-float" style={{ animationDelay: "3s" }} />
